...
// DAYS => array of weekday names (Sun, Mon, etc.)
// getDaysInMonth => returns total days in given month/year
// getFirstDayOfMonth => returns which day the month starts on (0–6)
